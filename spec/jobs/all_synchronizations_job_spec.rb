...
describe Maestrano::Connector::Rails::AllSynchronizationsJob do
  ...
  let(:organization_not_active) { create(:organization, oauth_provider: 'salesforce', sync_enabled: 0) }
  let(:organization_to_process) { create(:organization, oauth_provider: 'salesforce', sync_enabled: true) }
