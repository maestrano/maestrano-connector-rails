...
# -*- encoding: utf-8 -*-
# stub: maestrano-connector-rails 2.0.0.pre.RC4 ruby lib

Gem::Specification.new do |s|
  s.name = "maestrano-connector-rails"
  s.version = "2.0.0.pre.RC4"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<maestrano-rails>, ["= 1.0.0.pre.RC5"])
      ...
      s.add_dependency(%q<maestrano-rails>, ["= 1.0.0.pre.RC5"])
